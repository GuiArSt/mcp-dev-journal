 ...
 *
 * ### 2. Repository overview / Entry 0 (`repository_overviews`)
 ...
 * - **Example**: "tartarus-workspace" repository documentation
 ...
 * - **DB Location**: MCP `data/journal.db` → `repository_overviews` (+ Tartarus mirror)
 *
 ...
 *   Example: "tartarus-workspace" - architecture, tech stack, patterns
 *
...
export interface KronusSource {
  type:
    ...
    | "conversation"
    | "tartarus_object";
  identifier: string; // commit_hash, slug, ENG-XXX, UUID, etc.
  title?: string;
